        ...
        <div className='mx-auto pb-5 w-full '>
            <div className='mb-6'>
                <div className='flex items-center border-2 border-gray-200 rounded'>
                    ...
                    <input className='w-full py-2 px-4 rounded bg-white' placeholder='search products...' value={searchTerm}
                    ...
                    isLoading ? (<ProductLoader/>) : (products.map((product) => (
                        <div key={product.productId} className='border shadow rounded-md p-4 max-w-full w-full mx-auto'>
                            <div className='flex flex-col items-center'>
                                <Image src={`https://s3-invent.s3.ap-south-1.amazonaws.com/product${Math.floor(Math.random()*3)+1}.png`} alt={product.name} width={150} height={150} className="mb-3 rounded-2xl w-36 h-36"/>
