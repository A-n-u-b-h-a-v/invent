            ...
            {dashboardMetrics?.popularProducts.map((product) => (
              ...
              >
                <div className="flex items-center gap-3">
                 <Image src={`s3-invent.s3.ap-south-1.amazonaws.com/product${Math.floor(Math.random()*3)+1}.png`} alt={product.name} width={48} height={48} className="rounded-lg w-14 h-14"/>
